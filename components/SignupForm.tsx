...
export default function SignupForm({ plan, billing }: SignupFormProps) {
  ...
  return (
    <div className="w-full max-w-2xl bg-gray-900 rounded-xl p-10 shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg transition disabled:opacity-50 text-lg"
        >
