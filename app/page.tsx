  ...
  const performanceItems = [
    {
      ...
      desc: "Real-time SPY swing trade alerts powered by The One Stocks algorithm, delivering a 98% historical win rate on the S&P 500 ETF.",
    },
    {
      ...
      desc: "Harness our 4-hour SPY liquidity and momentum signals to capture market swings with a 98% win rate, backed by rigorous backtesting.",
    },
    {
      src: "/images/theonestocks9897.png",
      alt: "Multi-index strategy with 97% win rate",
      title: "The One Multi-Index Analyzer | 97% Win Rate on SPY & Nasdaq",
      desc: "Trade both SPY and Nasdaq with a unified algorithmic strategy that posts a 97% win rate across major equity indices.",
    },
    {
      src: "/images/theoneelitegbpusd1097.png",
      alt: "GBP/USD forex strategy with 97% win rate",
      title: "The One Forex Signal for GBP/USD | 97% Win Rate on 1-Hour Chart",
      desc: "Precision GBP/USD entry and exit signals on the 1-hour timeframe, delivering a 97% win rate for high-confidence forex trades.",
    },
  ];
      ...
      <section className="bg-gradient-to-r from-gray-900 to-black py-24 px-4 md:px-12">
        <div className="max-w-6xl mx-auto text-center space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-white">
            <StatCard label="Win Rate" value="98%" />
            <StatCard label="Profit Factor" value="4.36" />
            <StatCard label="Free Trial" value="30 Days" />
          </div>
          <Link
            href="/auth?screen_hint=signup"
...
function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="p-8 rounded-xl bg-gray-800 shadow-lg">
      <h3 className="text-4xl font-bold text-green-400">{value}</h3>
